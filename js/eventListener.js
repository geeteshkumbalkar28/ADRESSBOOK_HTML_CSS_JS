...
isMobileNumberValid = (mobileNo, regex = /^([+0-9]{3}.{1}[0-9]{6,11})$/)=> regex.test(mobileNo);
...
const createAndUpdateStorage = () => {
    ...
    //  alert(isUserNameValid(addressBookObj._name))
    ...
    window.location.replace("../pages/AddressBookApp.html");
    // if(checkName(addressBookObj.name()))
    // {
        
    //     if(checkNumber(addressBookObj.phoneNumber()))
    //     {
